package com.zhichanzaixian.trademarkapi.result;
...
public class ResultOld<T>  extends Result<T> {
    ...
    public static ResultOld<Object> ok() {
        return new ResultOld<>(CODE_SUCCESS, "", null);
    }

    public static ResultOld<Object> ok(String message) {
        return new ResultOld<>(CODE_SUCCESS, message, null);
    }

    public static <T> ResultOld<T> success(T data) {
        return new ResultOld<>(CODE_SUCCESS, MESSAGE_SUCCESS, data);
    }

    public static <T> ResultOld<T> success(T data, String message) {
        return new ResultOld<>(CODE_SUCCESS, message, data);
    }
